...
public abstract class Draft7EvaluatorFactoryTest extends EvaluatorFactoryTest {
    public Draft7EvaluatorFactoryTest() {
        super(SpecificationVersion.DRAFT7);
    }
    ...
    private static Stream<String> getUnsupportedKeywords() {
        return Stream.of(DYNAMIC_REF, RECURSIVE_REF, UNEVALUATED_ITEMS, UNEVALUATED_PROPERTIES, PREFIX_ITEMS,
                MAX_CONTAINS, MIN_CONTAINS, DEPENDENT_REQUIRED, DEPENDENT_SCHEMAS);
    }

    private static Stream<String> getIgnoredKeywords() {
        return Stream.of(ID, SCHEMA, COMMENT, DEFINITIONS, THEN, ELSE);
    }
}